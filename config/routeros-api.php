...
return [
    ...
    'host' => env('MIKROTIK_HOST', '192.168.88.1'), // Ambil dari .env, default ke 192.168.88.1
    'user' => env('MIKROTIK_USER', 'admin'),        // Ambil dari .env, default ke admin
    'pass' => env('MIKROTIK_PASS', null),           // Ambil dari .env, default null
    'port' => env('MIKROTIK_PORT', 8728),          // Ambil dari .env, default 8728
